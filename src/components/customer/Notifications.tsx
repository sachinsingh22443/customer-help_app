...
export function Notifications({ onBack }: NotificationsProps) {
  ...
  const getNotificationTime = (notification: any) => {
    /*
      Backend normally sends created_at.

      We also keep fallbacks so existing notifications
      don't break if their field name is different.
    */
